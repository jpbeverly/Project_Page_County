...
acs5_subject <- load_variables(2010, "acs5/subject", cache=T)
#View(acs5_subject)

acs5_profile<- load_variables(2010, "acs5/profile", cache=T)
#View(acs5_profile)
...
view(acs_VA_CO)
indicator_data <- as.data.frame(acs_VA_CO[,c(100,111,112,113,114,115,116,117,118,119,120,121)])
indicator_data <- indicator_data[,-11]
view(indicator_data)
